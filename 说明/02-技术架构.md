...
本文件已按当前部署架构修订：线上以 9445-9448 HTTPS 入口为主；静态 HTML 由 scripts/render-static.mjs 在服务器生成自动 Git 版本号；服务器通过 deploy/auto-deploy.sh 自动拉取 Git 并部署。
...
| web-mini | 8096 | 9446 | uniapp/dist/build/h5 |
